...
mt_wt_sample_groups<-list(
            #"ID3_KO_Irr"=c("ID3_KO_Irr_1", "ID3_KO_Irr_2","ID3_KO_Irr_3"),
            "ID3_KO_unIrr"=c("ID3_KO_unIrr_1", "ID3_KO_unIrr_2","ID3_KO_unIrr_3"),
            #"wt_Irr"=c("wt_Irr_1", "wt_Irr_2","wt_Irr_3")#,
            "wt_unIrr"=c("wt_unIrr_1", "wt_unIrr_2","wt_unIrr_3")
        )
...
group_colors<-c("onDox"=mut_wt_cols[1],"offDox"=mut_wt_cols[2])

hek_cols<-ggsci:::pal_npg()(10)[c(4,5,9,1,2,3,7)]
group_colors<-setNames(hek_cols, names(sample_groups))

id3_cols<-ggsci:::pal_npg()(10)[c(4,5,9,1)]
group_colors<-setNames(id3_cols, names(sample_groups))
...
#ANALYSIS="UTX_peaks_rep1"
#ANALYSIS="UTX_changed_SEs"
#ANALYSIS="UTX_peaks_rep1"

#ANALYSIS="UTX_peaks_rep1_data_only"
#ANALYSIS="UTX_peak_proximal_TSSs"
#ANALYSIS="UTX_peak_proximal_TSSs_rep1_data_only"
#ANALYSIS="UTX_peaks_union"
#ANALYSIS="UTX_peaks_rep1_gene_model"

ANALYSIS="E2F1_peaks_repair_promoters"

ANALYSIS="E2F1_motifs_10k_random"

ANALYSIS="E2F1_motifs_repair_promoters"

ANALYSIS="E2F1_motifs_repair_promoters_1kb"

ANALYSIS="E2F1_motifs_repair_promoters_DE_Irr_2_5_kb"

#ANALYSIS="E2F1_motifs_repair_promoters_DE_unIrr_2_5_kb"

#ANALYSIS="E2F1_motifs_repair_promoters_Irr_2_5_kb"

ANALYSIS="E2F1_motifs_repair_promoters_unIrr_2_5_kb"
...
ANNOTATION_DIRS[["E2F1_peaks_repair_promoters"]]="/C010-datasets/Internal/2018-Ali/annotations/promoters_repair_genes/"

ANNOTATION_DIRS[["E2F1_motifs_10k_random"]]="/C010-datasets/Internal/2018-Ali/annotations/tf_motifs_subs/"

ANNOTATION_DIRS[["E2F1_motifs_repair_promoters"]]="/C010-datasets/Internal/2018-Ali/annotations/tf_motifs_rep_prom/"

ANNOTATION_DIRS[["E2F1_motifs_repair_promoters_1kb"]]="/C010-datasets/Internal/2018-Ali/annotations/tf_motifs_rep_prom/"

ANNOTATION_DIRS[["E2F1_motifs_repair_promoters_DE_Irr_2_5_kb"]]="/C010-datasets/Internal/2018-Ali/annotations/promoters_repair_genes_DE_Irr/"

ANNOTATION_DIRS[["E2F1_motifs_repair_promoters_DE_unIrr_2_5_kb"]]="/C010-datasets/Internal/2018-Ali/annotations/promoters_repair_genes_DE_unIrr/"

ANNOTATION_DIRS[["E2F1_motifs_repair_promoters_Irr_2_5_kb"]]="/C010-datasets/Internal/2018-Ali/annotations/tf_motifs_rep_prom/"

ANNOTATION_DIRS[["E2F1_motifs_repair_promoters_unIrr_2_5_kb"]]="/C010-datasets/Internal/2018-Ali/annotations/tf_motifs_rep_prom/"
...
OUT_DIR=file.path("/ngs_share/scratch/pavlo/id3/analysis/integrative/summaries/", 
...
if(TRUE){
    BW_DIRS<- c(
            ...
            "ChIP"="/C010-datasets/Internal/2018-Ali/ACTseq/tracks/scaled/"#,
...
for(BW_DIR in BW_DIRS){
    ...
    qsub_call<-paste0("qsub -N bwtool_${ANALYSIS}_${rgn}_${samp} -l h_vmem=10G,virtual_free=10G -b y \\\n",
            "-e $TMP_DIR/logs/$ANALYSIS/bwtool_${rgn}_${samp}.err -o $TMP_DIR/logs/bwtool_${rgn}_${samp}.log \\\n",
            sep="")
    parallel_call<-paste0("")
    ...
    command<-paste(
            ...
            "do\n",
            sprintf("samp=${bwig%%.%s}\n", BW_EXTENSION),
            if(QSUB) qsub_call else parallel_call,
            bwtool_call,
            "done\n",
            "done\n",
            sep="")
...
comp_groups<-c("ID3_KO_Irr", "wt_Irr")
htsq<-list()
t.test.pvals<-list()
...
#            comp_groups<-c("WT", "MT")
    ...
    comp_marks<-c("H3K27me3", "H3K4me3")
    comp_marks<-c("H3K4me3", "H3K27me3")
    comp_marks<-NULL
...
#plot_marks<-c("G34W","H3.3","K36me3", "K27me3", "K27ac", "K9me3", "K4me3", "K4me1", "WGBS")


#plot_marks<-c("UTX","H3K27me3", "H3K27Ac", "H3K4me3", "H3K4me1")

plot_marks<-c("E2F1", "IgG")
...
#plot_marks<-c("H3.3","K27me3", "K9me3")
...
CLUSTER_AVERAGE_PLOTS<-TRUE
CLUSTER_AVERAGE_BOXPLOTS<-TRUE
...
GROUP_AVG_COMPARISONS<-list(c("ID3_KO_Irr","wt_Irr"))
MARK_AVG_COMPARISONS<-list(c("H3K27me3","H3K27Ac"), c("UTX", "H3K4me3"))
MARK_AVG_COMPARISONS<-list(c("E2F1", "IgG"))
    ...
    for(feat in plot_features){
        ...
        if(CLUSTER_PROFILE_PLOTS){
            ...
            for(cid in cids[valid_clusters]){
                #FEATURE_SUBSET<-TARGET_CLUSTER<-2
